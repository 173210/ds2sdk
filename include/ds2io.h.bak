...
*		ds2_flipScreen is called, up_screen_addr and/or audio_buffer_addr 
...
*	done: after updating video data, the up_screen_addr and/or audio_buffer_addr
...
*			and/or audio_buffer_addr pointer. it will not sure the graphic just
...
/*
*	Function: there are 4 audio buffers on the ds2io layer, this function to
...
*	NOTE: ds2_getAudiobuff may return NULL, even if ds2_checkAudiobuff() < 4.
*		The fact are that, 4 audio buffers are on NDS, the ds2io layer using 
*		2 other buffers transfering data to the 4 audio buffers alternately,
